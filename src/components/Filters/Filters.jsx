    ...
    <>
      ...
      <ul className={classes.filters__list}>
        <li key="all" className={classes.filters__item}>
          ...
          />
          <label className={classes.filters__label} htmlFor="all">
            Все
          </label>
        </li>
        <li key="no-transfer" className={classes.filters__item}>
          <input
            ...
            checked={isCheckedNo}
          />
          <label className={classes.filters__label} htmlFor="no-transfer">
            Без пересадок
          </label>
        </li>
        <li key="one-transfer" className={classes.filters__item}>
          ...
          />
          <label className={classes.filters__label} htmlFor="one-transfer">
            1 пересадка
          </label>
        </li>
        <li key="two-transfer" className={classes.filters__item}>
          ...
          />
          <label className={classes.filters__label} htmlFor="two-transfer">
            2 пересадки
          </label>
        </li>
        <li key="three-transfer" className={classes.filters__item}>
          <input
            ...
            type="checkbox"
            value="Три пересадки"
            onChange={threeChecked}
            checked={isCheckedThree}
          />
          <label className={classes.filters__label} htmlFor="three-transfer">
            3 пересадки
          </label>
        </li>
      </ul>
